...
builder = pyspark.sql.SparkSession.builder.appName("init-dev-etl") \
...
dt_subscriptions = spark.read.format("delta").load("s3a://lakehouse/development/delta/silver/subscriptions")
