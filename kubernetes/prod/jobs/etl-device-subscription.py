...
1) - reading json files from S3 {landing zone}
2) - build etl logic using pyspark & spark sql
3) - create tables using iceberg format
4) - store iceberg tables into S3 {warehouse}
5) - use apache nessie as catalog engine
6) - deploy code using {spok}, spark-on-k8s-operator

orchestration engine = {apache airflow}
- enhance pipeline process
"""

# TODO implement merge strategy
# TODO add iceberg features
